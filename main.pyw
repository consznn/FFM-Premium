...
if __name__ == "__main__":
    try:
        ...
        mutex_name = "FFP_SingleInstance_Mutex"
        # 0x01 = MUTEX_ALL_ACCESS (not needed, 0 is fine for just checking existence)
        mutex = ctypes.windll.kernel32.CreateMutexW(None, False, mutex_name)
        if ctypes.windll.kernel32.GetLastError() == 183: # ERROR_ALREADY_EXISTS
            ctypes.windll.user32.MessageBoxW(0, "Another instance of FFP is already running.", "FFP", 0x10) # 0x10 = MB_ICONERROR
            sys.exit(0)
            ...
            if getattr(sys, 'frozen', False):
                ...
                if missing:
                    ...
                    ctypes.windll.user32.MessageBoxW(0, 
                        ...
                        "FFP - Setup", 0x40) # 0x40 = MB_ICONINFORMATION
